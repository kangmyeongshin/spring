...
<article>
  ...
  <div id="goods_image">
    <figure>
      <img alt="HTML5 &amp; CSS3" src="${ctxPath}/goods/thumbnail?goods_id=${goodsVO.GOODS_ID}&fileName=${goodsVO.FILENAME}">
    </figure>
  </div>
  <div id="detail_table">
    <table>
  ...
  <div id="container">
    ...
    <div class="tab_container">
      <div class="tab_content" id="tab1" style="display: block;">
        ...
        <img src="${ctxPath}/goods/download.do?goods_id=${goodsVO.GOODS_ID}&fileName=${goodsImageVO.FILENAME}">
      </div>
