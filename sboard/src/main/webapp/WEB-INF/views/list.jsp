...
<html>
	...
	<body>
		<div id="board">
			...
			<!-- 리스트 -->
			<div class="list">
				<p class="logout">${member.nick }
				<a href="/sboard/member/logout">[로그아웃]</a><p>
				<table>
					<tr>
						<td>번호</td>
						<td>제목</td>
			...
			<nav class="paging">
				...
				<a href="#" class="num">1</a>						<a href="/sboard/list?pg=${ groupStartEnd[0]-1 }" class="prev">이전</a>
				<a href="#" class="next">다음</a>					</c:if>
